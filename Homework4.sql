...
SELECT STUDENT_ID
FROM REGISTRATION AS STUDENT_TABLE
WHERE COURSE_CODE = 'CS052' 
AND GRADE = (SELECT MAX(GRADE_TABLE.GRADE) 
	FROM REGISTRATION AS GRADE_TABLE 
	WHERE GRADE_TABLE.COURSE_CODE = 'CS052' 
	AND STUDENT_TABLE.STUDENT_ID = GRADE_TABLE.STUDENT_ID);
